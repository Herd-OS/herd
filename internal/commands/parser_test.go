...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{"uppercase prefix ignored", "/Herd fix-ci", nil, false},
		{"all-caps prefix ignored", "/HERD fix-ci", nil, false},
		{"mixed-case prefix ignored", "/HeRd fix-ci", nil, false},
		{"command mid-line not on own line", "I tried /herd fix-ci but it failed", nil, false},
		...
		{"quoted prompt preserves trailing same-line text", `/herd fix "update auth" include regression tests`, &Command{Name: "fix", Prompt: "update auth include regression tests"}, false},
		{"quoted prompt preserves trailing same-line text and remaining lines", "/herd fix \"update auth\" include regression tests\nkeep multiline context", &Command{Name: "fix", Prompt: "update auth include regression tests\nkeep multiline context"}, false},
