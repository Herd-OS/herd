...
func TestDefault(t *testing.T) {
	...
	assert.Equal(t, DefaultControlPlaneURL, "https://api.herd-os.com")
...
platform:
  ...
  owner: "my-org"
  repo: "my-project"
control_plane_url: "https://herd.example.com"
agent:
  provider: "claude"
workers:
  max_concurrent: 5
...
`
	...
	assert.Equal(t, "https://herd.example.com", cfg.ControlPlaneURL)
