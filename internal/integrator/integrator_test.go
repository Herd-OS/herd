...
func TestRunWorkerCompletionCycle_DrainsLatePendingWorkerBeforeReview(t *testing.T) {
	...
	assert.Equal(t, 1, ag.calls, "review should run once after the pending worker is drained")
