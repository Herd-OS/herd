...
Internal design documents for HerdOS. These explain the **why** and **how it fits together** — not the code-level details (the code is the source of truth for those).
